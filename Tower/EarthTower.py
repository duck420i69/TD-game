...
class EarthTower(Tower):
    def __init__(self, map_, x, y, lv):
        ...
        self.bullet_image = load_image(get_tower_property("EarthTower", "bullet_image"))
        self.image = load_image(get_tower_property("EarthTower", "tower_image"))

    def get_stat(self):
        stats = get_tower_stats("EarthTower", self.lv)
